...
class SetCriterion(nn.Module):
    ...
    def forward(self, outputs, targets, num_boxes=None):
        ...
        Parameters:
             ...
             num_boxes: pre-computed average number of target boxes across all nodes.
                        If None, it will be computed internally with an all_reduce.
        """
...
class PostProcess(nn.Module):
    ...
    def forward(self, outputs, target_sizes, original_target_sizes=None):
        ...
        results = [{"scores": s, "labels": lab, "boxes": b} for s, lab, b in zip(scores, labels, boxes)]
